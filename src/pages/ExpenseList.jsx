        ...
        <div className="content">
            <div className="page-header">
                ...
                <div className="page-btn">
                    <Link to="/add-expense" className="btn btn-added">
                        <img src="/assets/img/icons/plus.svg" alt="img" className="me-1" />Add Expense
                    </Link>
                </div>
            </div>
                    ...
                    <div className="card" id="filter_inputs">
                        <div className="card-body pb-0">
                            <div className="row">
                                ...
                                <div className="col-lg-2 col-sm-6 col-12">
                                    <div className="form-group">
                                        <input type="text" className="datetimepicker" placeholder="Choose Date" />
                                    </div>
                                </div>
                                <div className="col-lg-2 col-sm-6 col-12">
                                    <div className="form-group">
                        ...
                        <table className="table datanew">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Office snacks</td>
                                    <td>
                                        <Link className="me-3" to="/edit-expense">
